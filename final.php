...
class CampusNumChambery extends CampusNumerique implements iOdrey, iTibo
{

    use tAwsome, tFrenchTechInTheAlps{
        tAwsome::genial insteadof tFrenchTechinTheAlps;  
        slogan as sloganBidon;
    }
